...
function SearchUserCard({ users }: { users: User[] }) {
                        ...
                        {currentUsers.map((element, index) => (
                            <div key={startIndex + index} className="p-2 relative bg-gradient-to-br group from-zinc-900 to-zinc-950  cursor-pointer rounded-3xl border border-zinc-800 flex flex-col gap-2 w-full ">
                                <div className="flex justify-center relative w-full overflow-hidden rounded-2xl">
                                    ...
                                    <div className="absolute top-1 right-1 p-1 px-1.5 bg-green-500/40 backdrop-blur-2xl rounded-full text-xs drop-shadow-2xl flex items-center text-white">{element.cost}</div>
                                    {/* Active status dot */}
                                    {element.active && (
                                    ...
                                    <div className="flex justify-between  px-2 absolute bottom-0 py-1 rounded-b-2xl backdrop-blur-sm w-full" >
                                        <div className="flex gap-1 items-center">
                                            <div className="text-md max-w-16 truncate text-zinc-100">{element.name}</div>
                                        </div>
                                                            ...
                                                            <>
                                                                {game === "valorant" ? (
                                                                    ...
                                                                    <div key={idx} className="bg-[#6DB8FA] p-1 rounded-md">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24">
                                                                            <path fill="#fff" d="m15.767 14.171l.097-5.05H12.4V5.197h3.99L16.872 0H7.128v24l5.271-.985V14.17z" />
                                                                        </svg>
                                                                    </div>
                                                                ) : game === "just-chatting" ? (
                                                                    ...
                                                                    <div key={idx} className="bg-[#5b8731] p-1 rounded-md">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 512 512">
                                                                            <path fill="#fff" d="M0 0h169.847v172.501H0zm340.775 0h170.094v172.501H340.775zm0 172.502H169.847v85.915H84.785V512h85.062v-86.668h170.928V512h85.866V258.417h-85.866z" />
                                                                        </svg>
                                                                    </div>
                                                                ) : game === "tiktok" ? (
                                                                    <div key={idx} className="bg-black p-1 rounded-md ">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24">
                                                                            <path fill="#fff" d="M16.6 5.82s.51.5 0 0A4.28 4.28 0 0 1 15.54 3h-3.09v12.4a2.59 2.59 0 0 1-2.59 2.5c-1.42 0-2.6-1.16-2.6-2.6c0-1.72 1.66-3.01 3.37-2.48V9.66c-3.45-.46-6.47 2.22-6.47 5.64c0 3.33 2.76 5.7 5.69 5.7c3.14 0 5.69-2.55 5.69-5.7V9.01a7.35 7.35 0 0 0 4.3 1.38V7.3s-1.88.09-3.24-1.48" />
                                                                        </svg>
                                                                    </div>
                                                                ) : game === "musician" ? (
                                                                    <div key={idx} className="bg-black p-1 rounded-md">
