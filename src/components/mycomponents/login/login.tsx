...
@keyframes verify-ring {
    ...
    50% { box-shadow: 0 0 0 2px rgba(14, 165, 233, 0.3); }
    100% { box-shadow: 0 0 0 0 rgba(14, 165, 233, 0); }
}

@keyframes success-ring {
    0% { box-shadow: 0 0 0 0 rgba(16, 185, 129, 0); }
    50% { box-shadow: 0 0 0 2px rgba(16, 185, 129, 0.3); }
    100% { box-shadow: 0 0 0 0 rgba(16, 185, 129, 0); }
}

@keyframes error-ring {
    0% { box-shadow: 0 0 0 0 rgba(239, 68, 68, 0); }
    50% { box-shadow: 0 0 0 2px rgba(239, 68, 68, 0.3); }
                ...
                <div className="relative">
                    <div className="py-3 flex flex-col gap-2 w-full sm:w-84 transition-all duration-500 transform translate-x-0 opacity-100">
                        ...
                        <Button 
                            ...
                            disabled={loading}
                            className="p-2 px-3 pr-4 group flex gap-2 justify-between items-center h-12 rounded-xl hover:bg-zinc-800/80 bg-zinc-800/40 transition-all duration-300"
                        >
                            <div className="p-1 bg-zinc-950/40 border border-zinc-800 rounded-lg">
