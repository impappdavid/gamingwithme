...
function TopCreators() {
    ...
    const topCreators = [
        {
            name: "Pacos",
            profilePic: "/profile/12.jpg",
            games: ["valorant", "csgo"],
            cost: "$0.99/game",
        },
        {
            name: "Andrea",
            profilePic: "/profile/61.jpg",
            games: ["youtube"],
            cost: "$0.99/1h",
        },
        {
            name: "Ninja",
            profilePic: "/profile/25.jpg",
            games: ["fortnite"],
            cost: "$14.99/30m",
        },
        {
            name: "Erica",
            profilePic: "/profile/100.jpg",
            games: ["just-chatting"],
            cost: "$52.99/s",
        },
        {
            name: "Emma",
            profilePic: "/profile/97.jpg",
            games: ["just-chatting"],
            cost: "$14.99/s",
        },
        {
        ...
        {
            name: "Pokie",
            profilePic: "/profile/31.jpg",
            games: ["tiktok"],
            cost: "$4.99/video",
        },
        {
            name: "Granny",
            profilePic: "/profile/40.jpg",
            games: ["minecraft"],
            cost: "$0.99/30m",
        },
        {
            name: "Josh",
            profilePic: "/profile/115.jpg",
            games: ["musician"],
            cost: "$144.99/s",
        },
    ]
                            ...
                            <div className="flex flex-col gap-2 px-1">
                                ...
                                <div className="flex">
                                    <div className="flex flex-wrap gap-1">
                                        {element.games.map((element, index) => (
                                            <>
                                                {element === "valorant" ? (
                                                    <div key={index} className="bg-[#ff4654] p-1 rounded-md">
                                                    ...
                                                    <div key={index} className="bg-[#de9b35] p-1 rounded-md">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24">
                                                    ...
                                                    <div key={index} className="bg-black p-1 rounded-md">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <Button className="h-7 bg-transparent border rounded-lg hover:bg-zinc-900 cursor-pointer transition-all duration-300"><MessageSquare className="text-zinc-400" /></Button>
                                    <Button className="h-7 bg-green-500/10 border border-green-500/50 rounded-lg hover:bg-green-500/20 cursor-pointer transition-all duration-300"><CalendarSearch className="text-green-500" /></Button>
