...
function TopCreators() {
    ...
    const suggestions = [
        {
            name: "Allan",
            profilePic: "/profile/75.jpg",
            games: ["valorant", "csgo", "just-chatting", "minecraft"],
            cost: "$0.99/game",
        },
        {
            name: "Ava",
            profilePic: "/profile/29.jpg",
            games: ["youtube"],
            cost: "$1.99/1h",
        },
        {
        ...
        {
            name: "Isa",
            profilePic: "/profile/38.jpg",
            games: ["just-chatting"],
            cost: "$2.99/s",
        },
        {
            name: "Pookie",
            profilePic: "/profile/32.jpg",
            games: ["just-chatting"],
            cost: "$4.99/s",
        },
        {
            name: "Hanna",
            profilePic: "/profile/52.jpg",
            games: ["valorant", "minecraft"],
            cost: "$14.99/1h",
        },
        {
            name: "Lacy",
            profilePic: "/profile/114.jpg",
            games: ["tiktok"],
            cost: "$9.99/video",
        },
        {
