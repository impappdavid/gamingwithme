    ...
    const suggestions = [
        {
            ...
            games: ["valorant", "csgo", "just-chatting", "minecraft"],
            cost: "$0.99/game",
        },
        {
            name: "Noah",
            profilePic: "/profile/104.jpg",
            games: ["youtube"],
            cost: "$1.99/1h",
        },
        {
            name: "Ava",
            profilePic: "/profile/58.jpg",
            games: ["fortnite"],
            cost: "$4.99/30m",
        },
        {
            name: "Isla",
            profilePic: "/profile/35.jpg",
            games: ["just-chatting"],
            cost: "$2.99/s",
        },
        {
            name: "Ethan",
            profilePic: "/profile/17.jpg",
            games: ["just-chatting"],
            cost: "$4.99/s",
        },
        {
            name: "Maya",
            profilePic: "/profile/48.jpg",
            games: ["valorant", "minecraft"],
            cost: "$14.99/1h",
        },
        {
            name: "Alex",
            profilePic: "/profile/15.jpg",
            games: ["tiktok"],
            cost: "$9.99/video",
        },
        {
            name: "Peter",
            profilePic: "/profile/77.jpg",
            games: ["minecraft"],
            cost: "$5.99/30m",
        },
    ]
